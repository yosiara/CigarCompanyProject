...
class RegistryInformation(models.TransientModel):
    _name = "l10n_cu_contract.registry_information"

    def _get_seed(self):
        return self.env['l10n_cu_base.reg'].get_seed('l10n_cu_contract')

    def _get_key(self):
        return self.env['l10n_cu_base.reg'].get_key('l10n_cu_contract')

    def _get_days(self):
        return self.env['l10n_cu_base.reg'].get_days('l10n_cu_contract')

    def _get_reg(self):
        status=self.env['l10n_cu_base.reg'].check_reg('l10n_cu_contract')
    ...
    def save_key(self):
        return self.env['l10n_cu_base.reg'].save_key('l10n_cu_contract', self.key)