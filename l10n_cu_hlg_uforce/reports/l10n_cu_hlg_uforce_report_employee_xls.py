...
class ReportEmployeeExcel(ExcelBase):
    ...
    def print_table1(self, ws, row=0):
        ...
        #list employees
        employees = self.model.env['hr.employee'].search([])
        ...
        for employee in employees:
            if self._check_identication_id(employee.identification_id) != 0 and employee.degree_id:
                first_name = ''
                last_name = ''
                second_last_name = ''
                ...
                if employee.first_name:
                    ...
                    employee_name = employee.name_related.split(' ')
                    first_name = employee_name[0]
                    last_name = employee_name[1]
                    second_last_name = employee_name[2]

                ws.write(row, 0, i + 1, style3)
                ws.write(row, 1,tools.ustr(first_name),style3)
                ws.write(row, 2, tools.ustr(''), style3)
                ws.write(row, 3, tools.ustr(last_name), style3)
                ws.write(row, 4, tools.ustr(second_last_name), style3)
                ...
                contract_type = self.model.env['l10n_cu_hlg_uforce.contract_hr_type'].search([('id', '=', employee.contract_hr_type_id.id)],limit=1).code
                ...
                category = 'Obreros'
                if employee.occupational_category_id.code == 'ADM':
                    category = 'Administrativo'
                elif employee.occupational_category_id.code == 'TEC':
                    category = 'Técnico'
                elif employee.occupational_category_id.code == 'OP':
                    category = 'Operario'
                elif employee.occupational_category_id.code == 'SER':
                    category = 'Servicio'
                elif employee.occupational_category_id.code == 'DIR':
                    category = 'Directivo'
                elif employee.occupational_category_id.code == 'DS':
                    category = 'Directivo Superior'
                elif employee.occupational_category_id.code == 'E':
                    category = 'Ejecutivo'
                elif employee.occupational_category_id.code == '00':
                    category = 'Estudiante'
                elif employee.occupational_category_id.code == 'OBR':
                    category = 'Obrero'
                else:
                    category = 'Obreros'
