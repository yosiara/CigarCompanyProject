...
class Organism(models.Model):
    _name = 'l10n_cu_hlg_uforce.organism'
...
class CenterStudy(models.Model):
    _name = 'l10n_cu_hlg_uforce.center_study'
...
class BranchScience(models.Model):
    _name = 'l10n_cu_hlg_uforce.branch_science'
...
class SpecialtyFamily(models.Model):
    _name = 'l10n_cu_hlg_uforce.specialty_family'
...
class Degree(models.Model):
    _name = 'l10n_cu_hlg_uforce.degree'
    ...
    parent_id = fields.Many2one('l10n_cu_hlg_uforce.degree', string='Degree parent', ondelete='cascade', index=True)
    child_ids = fields.One2many('l10n_cu_hlg_uforce.degree', 'parent_id', string='Childs Degrees')
...
#     _name = 'l10n_cu_hlg_uforce.employed'
#
...
#     degree_id = fields.Many2one('l10n_cu_hlg_uforce.degree', string='Degree', required=True)
#     municipality_id = fields.Many2one('l10n_cu_base.municipality', string='Municipality', required=True)
#     contract_type_id = fields.Many2one('l10n_cu_hlg_uforce.contract_type', string='Employment', required=True)
#     age_range_id = fields.Many2one('l10n_cu_hlg_uforce.age_range', string='Age Range', required=True)
...
class AgeRange(models.Model):
    _name = 'l10n_cu_hlg_uforce.age_range'
...
class ContractType(models.Model):
    _name = 'l10n_cu_hlg_uforce.contract_type'
...
class Employment(models.Model):
    _name = 'l10n_cu_hlg_uforce.employment'
...
class HireDropRecord(models.Model):
    _name = 'l10n_cu_hlg_uforce.hire_drop_record'
...
class GraduatesDemand(models.Model):
    _name = 'l10n_cu_hlg_uforce.graduates_demand'
    ...
    ministry_id = fields.Many2one('l10n_cu.ministry', string='Ministry', required=True)
    organism_id = fields.Many2one('l10n_cu_hlg_uforce.organism', string='Organism', required=True)
    ...
    degree_id = fields.Many2one('l10n_cu_hlg_uforce.degree', string='Degree', required=True)
    line_ids = fields.One2many('l10n_cu_hlg_uforce.graduates_demand_line', 'demand_id', string='Demand')
...
class GraduatesDemandLine(models.Model):
    _name = 'l10n_cu_hlg_uforce.graduates_demand_line'
    _description = 'Graduates Demand Line'

    demand_id = fields.Many2one('l10n_cu_hlg_uforce.graduates_demand', string='Demand', ondelete='cascade', required=True)
