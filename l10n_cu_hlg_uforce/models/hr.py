...
class Employee(models.Model):
    ...
    contract_hr_type_id = fields.Many2one('l10n_cu_hlg_uforce.contract_hr_type', string='Contract HR Type')
    age_range_id = fields.Many2one('l10n_cu_hlg_uforce.age_range', store=True,
    ...
    #fields required to dashboard
    school_level_name = fields.Char('School Level Name', related='school_level_id.name')
    age_range_code = fields.Char('Age Range Code', related='age_range_id.code')
...
class ContractHrType(models.Model):
    _name = 'l10n_cu_hlg_uforce.contract_hr_type'
